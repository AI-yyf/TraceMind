        ...
        >
          <Layout>
            <Routes>
              ...
              <Route path="/workbench" element={withPageFallback(<WorkbenchPage />)} />
              <Route path="/workbench/:topicId" element={withPageFallback(<WorkbenchPage />)} />
...
function TopicResearchRedirect() {
  ...
  return (
    <Navigate
      to={
        topicId
          ? `/topic/${encodeURIComponent(topicId)}?workbench=research`
          : '/research'
      }
      replace
    />
